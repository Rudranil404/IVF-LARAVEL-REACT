...
// ⚠️ NEW: Import the registration panel
...
export default function ClinicDashboard() {
    ...
    // ⚠️ NEW: State to control the sliding panel
        ...
        <div className="flex h-screen bg-slate-50 font-sans overflow-hidden">
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <div className="flex-1 flex overflow-hidden">
                    ...
                    <main className={`flex-1 flex flex-col overflow-y-auto p-6 md:p-8 transition-all duration-300 ease-in-out ${isRegOpen ? 'pr-4' : ''}`}>
                        
                        {/* Welcome Banner */}
                        <div className="bg-sky-600 rounded-2xl p-8 mb-8 text-white shadow-lg flex justify-between items-center relative overflow-hidden shrink-0">
                        ...
                        {/* Key Metrics Row */}
                        <div className={`grid gap-6 mb-8 shrink-0 ${isRegOpen ? 'grid-cols-1 md:grid-cols-2' : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-4'}`}>
                        ...
                        <div className={`grid gap-8 ${isRegOpen ? 'grid-cols-1' : 'grid-cols-1 lg:grid-cols-3'}`}>
                            <div className={`${isRegOpen ? '' : 'lg:col-span-2'} bg-white rounded-xl border border-slate-200 shadow-sm p-6`}>
                            ...
                            <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    {/* ⚠️ Changed this button to trigger the side panel instead of navigating */}
                                    <button 
                                        onClick={() => setIsRegOpen(true)} 
                                        className="w-full flex items-center justify-between p-3 border border-slate-200 rounded-lg hover:border-sky-500 hover:bg-sky-50 transition-colors text-left group"
                                    >
                    ...
                    >
                        <div className="w-[400px] xl:w-[480px] h-full">
                            <PatientRegistrationPanel 
                                ...
                                onSuccess={() => {
                                    setIsRegOpen(false);
                                    // You can add logic here to refresh dashboard stats!
                                }} 
                            />
                        </div>
                    </div>
